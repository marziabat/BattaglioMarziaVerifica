...
public class DocenteD extends JDialog implements ActionListener{
	...
	public DocenteD(JFrame j, boolean modale) {
		super(j, true);
		setSize(800,600);
	...
	public void actionPerformed(ActionEvent e) {
		try {
			if(e.getSource() == salva) {
				if(d == null) {
					d = new Docente(t1.getText(), t2.getText(), t3.getText(), t4.getText(), t5.getText());
					dispose();
				}
			}
		}catch(Exception ex) {
